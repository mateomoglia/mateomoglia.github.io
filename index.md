...
<ul class="paper-list">
  ...
  <li class="paper-item">
    <p class="paper-title">The Spatial Impacts of Population Ageing
      <span class="jmp-badge">Submitted</span>
    </p>
...
<ul class="teaching-list">
  ...
  <li class="teaching-item">
    <div>
      <div class="teaching-course">Introduction to Economics (Engineer)</div>
      <div class="teaching-role">Teaching Assistant &middot; Ecole Polytechnique</div>
    </div>
    <div class="teaching-date">Spring 2026</div>
  </li>

  <li class="teaching-item">
    <div>
      <div class="teaching-course">Introduction to R and Stata (Master)</div>
      <div class="teaching-role">Teaching Assistant &middot; Ecole Polytechnique</div>
    </div>
